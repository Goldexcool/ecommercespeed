      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-1 w-full">
        ...
        <div className="bg-white dark:bg-black p-8 rounded-lg shadow-input" data-aos="fade-left">
          ...
          <form className="my-8 " onSubmit={handleSubmit}>
            ...
            <button
              className="bg-gradient-to-br relative group/btn from-mainColor dark:from-mainColor dark:to-darker hover:black to-saturated block dark:bg-zinc-800 w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
              type="submit"
              data-aos="fade-up"
              data-aos-delay="2600"
            >
